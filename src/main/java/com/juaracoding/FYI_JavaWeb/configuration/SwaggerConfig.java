...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2).
                select().
                apis(RequestHandlerSelectors.basePackage("com.juaracoding.FYI_JavaWeb.controllers")).
...
//    String licenseUrl) {
    private ApiInfo apiInfo()
    {
        ApiInfo apiInfo = new ApiInfo(
                ...
                new Contact("Fitriyani","localhost:8080/api/v1","fitriyani07071@gmail.com"),//Contact Name
